...
sed -i 's|CST-8|WIB-7|g' feeds/kiddin/my-default-settings/files/etc/uci-defaults/99-default-settings
sed -i 's|Asia/Shanghai|Asia/Jakarta|g' feeds/kiddin/my-default-settings/files/etc/uci-defaults/99-default-settings
sed -i 's|bcm27xx-utils|bcm27xx-userland|g' feeds/kiddin/autocore/Makefile
