...
git clone --depth 1 -b v0.47.133 https://github.com/vernesong/OpenClash.git package/openclash
...
git clone --depth 1 -b 26.8.1-1 https://github.com/Openwrt-Passwall/openwrt-passwall.git package/luci-app-passwall
