...
cp -rf package/luci-app-adguardhome/root/etc/init.d/adguardhome feeds/packages/net/adguardhome/files/adguardhome.init
rm -rf package/luci-app-adguardhome/root/etc/init.d

# OpenClash
rm -rf feeds/luci/applications/luci-app-openclash
git clone --depth 1 -b v0.47.156 https://github.com/vernesong/OpenClash.git package/openclash
...
git clone --depth 1 -b 26.8.26-1 https://github.com/Openwrt-Passwall/openwrt-passwall.git package/luci-app-passwall
...
# Modify hostname
sed -i 's/ImmortalWrt/OrangePI/g' package/base-files/files/bin/config_generate
#
