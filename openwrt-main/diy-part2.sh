...
# OpenClash
git clone --depth 1 -b v0.47.006 https://github.com/vernesong/OpenClash.git package/openclash
...
# Add passwall
git clone --depth 1 -b 25.9.19-1 https://github.com/xiaorouji/openwrt-passwall.git package/luci-app-passwall
